...
def extract_color_features(img_rgb):
    ...
    descritores = descritores + [std_hist_H, kurt_hist_H, skew_hist_H, std_hist_S, kurt_hist_S, skew_hist_S, std_hist_V,
                                 kurt_hist_V, skew_hist_V]
    ...
    descritores = descritores + [std_hist_R, kurt_hist_R, skew_hist_R, std_hist_G, kurt_hist_G, skew_hist_G, std_hist_B,
                                 kurt_hist_B, skew_hist_B]
    ...
    descritores = descritores + [perc, inv_moments_1, inv_moments_2, inv_moments_3, inv_moments_4, inv_moments_5,
                                 inv_moments_6, inv_moments_7]
